...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-03-2022 a las 18:28:19
...
(9, 'El Rey León', 'El Rey León, el musical que ha batido todos los récords desde su estreno en 2011, vuelve por fin a la Gran Vía madrileña con más fuerza e ilusión que nunca. Ha comenzado así su 10ª temporada de éxito, en la que alcanzará las cifras históricas de 5 millones de espectadores, tras más de 3.500 representaciones en el teatro Lope de Vega.\r\n\r\nProducido por Stage Entertainment, El Rey León es la mayor producción musical jamás representada en España. Apto para toda la familia, atrapa de principio a fin y, tal y como ya han hecho más de 110 millones de personas de todo el mundo, hay que vivirlo, al menos, una vez en la vida.\r\n\r\n¡Ver El Rey León es una experiencia única!\r\n\r\nPor su espectacularidad. Un musical que te dejará sin palabras gracias a la sorprendente puesta en escena de una de la historias más conmovedoras de todos los tiempos.', 'img_9.jpg', '2022-04-19 22:00:00', '2022-03-01', '2022-03-31', 3),
(10, 'Grease el musical', 'GREASE EL MUSICAL es el fenómeno de la cultura pop que narra la vida en el instituto de una pequeña ciudad americana en los años 50, habiéndose convertido en el gran musical del Rock and Roll por excelencia, además de en una de las películas musicales más taquillera de la historia.\r\n\r\nCelebrando en 2021 los 50 años desde su estreno original en Chicago, GREASE continúa siendo una de las principales fuentes de inspiración para nuevas creaciones artísticas. SOM Produce se suma a este aniversario y estrena una nueva producción con una ambiciosa e innovadora puesta en escena, a cargo del mismo equipo creativo de Billy Elliot.', 'img_10.jpg', '2022-03-30 22:00:00', '2022-04-01', '2022-04-23', 3),
(11, 'Harlem Globetrotters ', 'GLOBETROTTERS EXPERIENCE\r\n¿Quieres sentirte como un auténtico Globetrotter? No te pierdas la oportunidad de vivir el mejor espectáculo del mundo de baloncesto ¡desde dentro de la cancha!, adquiriendo las entradas de la GLOBETROTTERS EXPERIENCE. ¡Siéntate al lado del banquillo, saluda a los jugadores en privado, y hazte fotos ¡Es una experiencia inolvidable! ', 'img_11.jpg', '2022-03-29 11:18:39', NULL, NULL, 4),
(12, 'CADIZ CF - RAYO VALLECANO', 'El Cádiz CF se enfrenta el domingo 6 de marzo a las 14:15 horas al Rayo Vallecano en el Estadio Nuevo Mirandilla.', 'img_12.jpg', '2022-03-26 11:20:27', NULL, NULL, 4);
